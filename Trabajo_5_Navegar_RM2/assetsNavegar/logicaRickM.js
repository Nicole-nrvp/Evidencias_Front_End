...
const getData = (api) => { 
    ...
    .then((json) => {
        mostrarDatos(json), navegacion(json.info) 
    })
    .catch((error) => {
...
const navegacion=(data) => {
        ...
        let html = "";
    htmls += `<li class="link"> <a onClick="getData('${data.prev}')"> Siguiente </a> </li>`;
    htmls += `<li class="link"> <a onClick="getData('${data.next}')"> Siguiente </a> </li>`;
    
    document.getElementById("paginar").innerHTML = html;
